...
**Evidence base:** `notebooks/07_phase3_preprocess.ipynb` Findings A–E + Part 2 decisions
**Code:** `backend/core/preprocessing.py` · **Tests:** `backend/tests/test_preprocessing.py`
...
`haversine` + runway distance → `backend/core/geo.py`; `flight_phase` + Filter-B
derivations → `backend/core/derivations.py` (leaf modules, no credentials).
...
- Evidence: `notebooks/07_phase3_preprocess.ipynb` (Findings A–E, Part 2 decisions, Part 3 validation)
