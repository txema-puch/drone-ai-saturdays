...
These files are application release bundles, not Hugging Face Transformers models and not hosted
inference endpoints. The current product is rules-first: it reconstructs approach attempts,
checks telemetry quality, infers runway-relative geometry when supported, and exposes criterion
...
The LSTM bundle is kept for reproducibility and comparison. It is not a second production model
and is not part of the current decision path.
...
- [Active design](https://github.com/txema-puch/drone-ai-saturdays/blob/develop/backend/docs/designs/33-approach-conformance-reframe.md)
- [Rules-first decision](https://github.com/txema-puch/drone-ai-saturdays/blob/develop/backend/docs/ml/decisions/D-015-rules-first-approach-screening.md)
- [Sealed evaluation](https://github.com/txema-puch/drone-ai-saturdays/blob/develop/backend/docs/ml/iterations/approach-screening/07-eval.md)
- [Contextual evaluation](https://github.com/txema-puch/drone-ai-saturdays/blob/develop/backend/docs/ml/iterations/approach-context/07-eval.md)
