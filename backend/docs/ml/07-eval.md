...
- `backend/scripts/phase7_burn.py` (present in the provenance commit; absent from the current
  working tree and therefore not silently recreated here)
- `backend/models/phase6/phase7_burn_results.json`
- `notebooks/13_phase7_eval.ipynb` (present in the provenance commit)
...
holdout; see [`pending-work.md`](./pending-work.md).
