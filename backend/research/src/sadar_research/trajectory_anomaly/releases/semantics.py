...
Unlike :mod:`sadar_research.trajectory_anomaly.releases.schema`, this boundary may use dataframe/parquet and ML
...
from sadar_research.trajectory_anomaly.releases.artifacts import (
...
from sadar_research.trajectory_anomaly.demo.operations import case_identity, operation_ref, severity_band
