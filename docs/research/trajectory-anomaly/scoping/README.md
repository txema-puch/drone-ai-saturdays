...
labeling. See
[`../ml/decisions/D-015-rules-first-approach-screening.md`](../../../product/decision-rules-first.md)
and [`../ml/iterations/approach-screening/07-eval.md`](../../approach-screening/lifecycle/07-eval.md).
...
Full design: [architecture/design-trajectory-anomaly-detection.md](../original-design.md)
