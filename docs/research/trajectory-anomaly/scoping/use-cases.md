...
The original Scenario 8 framing (three-class intent classification) was rejected — no labeled hostile dataset exists. Reframed as anomaly detection: learn what normal authorized flight looks like near LEMD, flag deviations. See [decisions/README.md](README.md) for full rationale.
...
**Selected: Use Case 1 — Airports (LEMD)** — decided 2026-04-11, whole team. Logged as D-001 in [decisions/README.md](README.md).
