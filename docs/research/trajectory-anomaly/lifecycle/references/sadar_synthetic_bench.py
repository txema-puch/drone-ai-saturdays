...
#          docs/research/trajectory-anomaly/lifecycle/07-eval-prep.md > "Reference implementation —
...
# (backend/research/src/sadar_research/trajectory_anomaly/pipeline/preprocessing.py) — POST-#25 (Phase 5 closed):
...
#     call sadar_research.trajectory_anomaly.pipeline.features.apply_segment_derivations(seg) (replays hdg_sin/cos +
...
#     APW/geofence Layer-3 baseline also binds to: sadar_research.trajectory_anomaly.data.geometry.distance_to_closest_runway).
