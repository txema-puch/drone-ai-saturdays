...
Layer 1 was previously underspecified ("training loss curves and reconstruction overlays"). Phase 4's motion-feature normality audit (`docs/research/trajectory-anomaly/lifecycle/04-eda.md > Insight 7`) produced a concrete cohort and a two-channel sanity test, locked here.
...
- Phase 7 protocol: codified in
  `docs/research/trajectory-anomaly/lifecycle/07-eval-prep.md > External validation (Layer 4)`
...
- Design doc's geofence-baseline realism check (`docs/research/trajectory-anomaly/original-design.md`)
- 07-eval-prep.md's synthetic-injection calibration (Layer 2 source)
- `docs/research/trajectory-anomaly/lifecycle/04-eda.md > Sanity-validation cohort proposal` — Phase 4 derivation of the cohort
