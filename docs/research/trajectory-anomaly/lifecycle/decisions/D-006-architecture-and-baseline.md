...
See the archived architectural-critique draft listed in `docs/archive-manifest.yml` for the full reframe rationale. `01-problem.md > Scope evolution (post-Phase 1)` carries the parallel narrative note.

## References

- Design doc: `docs/research/trajectory-anomaly/original-design.md` (Model section)
...
- Medium-piece thesis (post-Phase 1 reframe): the archived architectural-critique draft listed in `docs/archive-manifest.yml`
