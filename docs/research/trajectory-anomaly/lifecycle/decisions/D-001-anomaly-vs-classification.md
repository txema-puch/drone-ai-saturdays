...
- Design doc: `docs/research/trajectory-anomaly/original-design.md` (sections "Problem Statement," "Premises (Revised)," "Approaches Considered")
- Project-level decision log: `docs/research/trajectory-anomaly/scoping/README.md` (D-001 entry)
