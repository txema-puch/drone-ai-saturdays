...
`backend/src/sadar/approach/resources/lemd_runways_2026-07-09.json`. Applying current geometry historically is
a disclosed prototype assumption until historical effective charts are sourced.

## Feasibility audit

`backend/src/sadar/pipelines/feasibility.py` rejects the burned test fold. On train and 2019
