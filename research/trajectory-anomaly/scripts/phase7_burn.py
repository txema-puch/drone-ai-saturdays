# =============================================================================
# PRESERVED HISTORICAL ARTIFACT — Phase-7 test burn (issue #29).
#
# This is the exact one-shot script that produced the Phase-7 burn results
# recorded in docs/research/trajectory-anomaly/lifecycle/07-eval.md (and consumed
# as phase7_burn_results.json by the serving precompute). It is kept as evidence
# of HOW the burn numbers were generated.
#
# It targets the PRE-RESTRUCTURE package layout (`backend.core.*`, artifacts under
# `backend/models/phase6/`) that the repository refactor (PR #39) replaced with the
# `sadar_research.trajectory_anomaly` package. The `backend.core` imports below do
# NOT resolve against the current tree; older copies of that layout are preserved
# via the pre-restructure git tag. This file is not kept in execution parity with
# the tested research package (same status as the notebooks/archive/ notebooks).
# =============================================================================
