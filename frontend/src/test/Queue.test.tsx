...
const FLIGHTS: api.FlightSummary[] = [
  { ...COVERAGE, case_id: "c_zfhbuqelexy6rzhl", case_ref: "CASE-ZFHBUQELEXY6Q", operation_ref: "OP-345051-1580731490", segment_id: "345051_1580731490#1", score: 1.79, pct: 100, band: "highly anomalous", anomalous: true, label: "normal", has_case: true, n_steps: 402, truncated: true, terminal_op: false },
  { ...REVIEWABLE, case_id: "c_c2bwwjgaxbqg43kb", case_ref: "CASE-C2BWWJGAXBQG4", operation_ref: "OP-502CE6-1543855510", segment_id: "502ce6_1543855510#1", score: 1.5, pct: 99, band: "highly anomalous", anomalous: true, label: "go_around", has_case: true, n_steps: 238, truncated: false, terminal_op: true },
  { ...REVIEWABLE, case_id: "c_26fr5zzkc52t2iax", case_ref: "CASE-26FR5ZZKC52T2", operation_ref: "OP-502CE6-1543855510", segment_id: "502ce6_1543855510#2", score: 0.12, pct: 40, band: "normal range", anomalous: false, label: "normal", has_case: false, n_steps: 80, truncated: false, terminal_op: true },
  { ...REVIEWABLE, case_id: "c_ua7ew2neyk35mnwz", case_ref: "CASE-UA7EW2NEYK35M", operation_ref: "OP-ABCDEF-1580731000", segment_id: "abcdef_1580731000#1", score: 0.05, pct: 12, band: "normal range", anomalous: false, label: "normal", has_case: false, n_steps: 120, truncated: false, terminal_op: true },
];

const OPERATIONS: api.OperationSummary[] = [
  {
    operation_ref: "OP-345051-1580731490", segment_count: 1, flagged_segment_count: 1,
    worst_score: 1.79, worst_pct: 100, worst_band: "highly anomalous", worst_case_id: FLIGHTS[0].case_id, worst_case_ref: FLIGHTS[0].case_ref,
    worst_segment_id: FLIGHTS[0].segment_id, worst_has_case: true,
    ...
    assessment_summary: "not assessable", behavioral_assessment: "not_assessable", behavioral_flagged_segment_count: 0, reviewable_segment_count: 0, not_assessable_segment_count: 1, data_quality_segment_count: 0, coverage_limited_segment_count: 1, behavioral_worst_score: null, behavioral_worst_pct: null, behavioral_worst_band: null, behavioral_worst_case_id: null, behavioral_worst_case_ref: null,
    segments: [FLIGHTS[0]],
  },
  {
    operation_ref: "OP-502CE6-1543855510", segment_count: 2, flagged_segment_count: 1,
    worst_score: 1.5, worst_pct: 99, worst_band: "highly anomalous", worst_case_id: FLIGHTS[1].case_id, worst_case_ref: FLIGHTS[1].case_ref,
    worst_segment_id: FLIGHTS[1].segment_id, worst_has_case: true,
    ...
    assessment_summary: "reviewable", behavioral_assessment: "reviewable", behavioral_flagged_segment_count: 1, reviewable_segment_count: 2, not_assessable_segment_count: 0, data_quality_segment_count: 0, coverage_limited_segment_count: 0, behavioral_worst_score: 1.5, behavioral_worst_pct: 99, behavioral_worst_band: "highly anomalous", behavioral_worst_case_id: FLIGHTS[1].case_id, behavioral_worst_case_ref: FLIGHTS[1].case_ref,
    segments: [FLIGHTS[1], FLIGHTS[2]],
  },
  {
    operation_ref: "OP-ABCDEF-1580731000", segment_count: 1, flagged_segment_count: 0,
    worst_score: 0.05, worst_pct: 12, worst_band: "normal range", worst_case_id: FLIGHTS[3].case_id, worst_case_ref: FLIGHTS[3].case_ref,
    worst_segment_id: FLIGHTS[3].segment_id, worst_has_case: false,
    ...
    assessment_summary: "reviewable", behavioral_assessment: "reviewable", behavioral_flagged_segment_count: 0, reviewable_segment_count: 1, not_assessable_segment_count: 0, data_quality_segment_count: 0, coverage_limited_segment_count: 0, behavioral_worst_score: 0.05, behavioral_worst_pct: 12, behavioral_worst_band: "normal range", behavioral_worst_case_id: FLIGHTS[3].case_id, behavioral_worst_case_ref: FLIGHTS[3].case_ref,
    segments: [FLIGHTS[3]],
  },
];
...
describe("Queue", () => {
  it("defaults to operation triage with honest worst-segment evidence", async () => {
    ...
    expect(screen.getByText(/Lane evidence: CASE-C2BWWJGAXBQG4 · Labels: go_around, normal · Assessment: reviewable/)).toBeInTheDocument();
